...
export const PopupTitle: React.FC<Props> = ({
  ...
  return (
    <a
      ...
      className="color-shift flex w-full items-center justify-between gap-2 rounded-md border border-stone-400 bg-white p-2 text-stone-900 hover:bg-stone-200 dark:border-stone-500 dark:bg-stone-700 dark:text-stone-200 dark:hover:bg-stone-800 dark:hover:text-stone-200 "
      target="_blank"
    >
