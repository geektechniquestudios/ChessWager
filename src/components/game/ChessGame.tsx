      ...
      <div className="flex h-full flex-col items-center justify-center gap-2 overflow-hidden p-2">
        <div className="relative my-0 flex w-full justify-center">
          <motion.div
            ...
            className="color-shift w-[30em] resize-x flex-col justify-center overflow-hidden rounded-xl border border-stone-500 bg-stone-200 p-1.5 align-middle text-stone-900 shadow-lg dark:border-stone-700 dark:bg-stone-800 dark:text-stone-300"
