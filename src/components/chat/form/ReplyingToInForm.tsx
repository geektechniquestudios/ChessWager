...
export const ReplyingToInForm: React.FC<Props> = ({}) => {
  ...
  return (
    <>
      {replyingToMessageId !== "" && message && (
        <div className="flex w-full items-center justify-between gap-2 border-b border-t border-stone-500 bg-stone-100 px-2 py-1 text-center text-stone-800 dark:border-stone-500 dark:bg-stone-600 dark:text-stone-300">
