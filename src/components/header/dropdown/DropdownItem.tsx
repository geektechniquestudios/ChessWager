...
export const DropdownItem: React.FC<Props> = ({
  ...
  return (
    ...
    <a
      href={address}
      className="h-14 w-64 px-4 flex items-center rounded-md hover:bg-stone-300 dark:hover:bg-stone-600 dark:text-stone-200 dark:hover:text-stone-200 color-shift"
      onClick={() => {
        onClick && onClick()
