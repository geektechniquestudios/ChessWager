...
export const ReportArea: React.FC<Props> = ({}) => {
  return (
    <div className="flex w-full flex-col justify-between">
      <p className="m-2 flex items-center justify-center gap-2 rounded-md border border-stone-500 bg-stone-100 py-2 text-lg dark:border-stone-700 dark:bg-stone-800">
        <GoReport />
        <>Tell Us What Happened</>
      </p>
      <div className="flex h-full flex-col justify-evenly">
        <div className="mx-2 flex flex-col rounded-md border border-stone-500 bg-stone-200 p-2 dark:border-stone-600 dark:bg-stone-900">
