...
export const HowToPlaySection: React.FC<Props> = ({
  ...
  return (
    <div className="color-shift relative flex justify-between gap-2 rounded-md border border-stone-400 bg-stone-100 p-2 dark:border-stone-500 dark:bg-stone-600">
