...
export const AvaxPriceButton: React.FC = () => {
  ...
  return (
    <motion.a
      ...
      className="color-shift clickable grid h-9 place-content-center rounded-md border-none text-center font-bold text-stone-800 hover:bg-stone-200 hover:text-black dark:text-stone-300 dark:hover:bg-stone-700 dark:hover:text-white"
