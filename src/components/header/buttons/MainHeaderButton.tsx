    ...
    <AnimatePresence mode="wait">
      {(user || !authRequired) && (
        <motion.button
          ...
          id={id}
          className={`${activeStyle} color-shift clickable z-50 grid h-9 w-9 place-content-center rounded-md text-stone-800 hover:bg-stone-300 hover:text-stone-600 dark:text-stone-300 dark:hover:bg-stone-700 dark:hover:text-white`}
          title={title}
          onClick={() => {
