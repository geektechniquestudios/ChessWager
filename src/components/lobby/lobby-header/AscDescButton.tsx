...
export const AscDescButton: React.FC = () => {
  ...
  return (
    <button
      className="color-shift clickable my-0.5 grid w-10 place-content-center rounded-md px-2 py-1 text-stone-900 hover:bg-stone-200 dark:text-stone-300 dark:hover:bg-stone-700"
      onClick={() => {
