    ...
    <AnimatePresence>
      {displayName && (
        <motion.div
          ...
          layout="position"
          className={`${justifyDirection} flex w-2/5 items-center text-xs font-extrabold text-stone-900 dark:text-stone-100`}
        >
          <p className="user-name overflow-hidden overflow-ellipsis whitespace-nowrap">
            {displayName}
          </p>
        </motion.div>
      )}
